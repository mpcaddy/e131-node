...
// get start code from this E1.31 packet
...
// set start code on this E1.31 packet
Packet.prototype.setStartCode = function setStartCode(startCode) {
  this._dmpLayer.setStartCode(startCode);
};
