...
// get start code from this DMP layer
...
// set start code on this DMP layer
DMPLayer.prototype.setStartCode = function setStartCode(startCode) {
  this.propertyValues[0] = startCode;
};
